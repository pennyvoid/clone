...
class FriendTest extends TestCase
{
    ...
    /** @test */
    public function a_user_can_send_a_request_friend()
    {
        $this->withoutExceptionHandling();
        $this->actingAs($user = factory(User::class)->create(), 'api');
        $anotheUser = factory(User::class)->create();
        $response = $this->post('/api/friend-request', [
            'friend_id' => $anotheUser->id
        ])->assertStatus(200);

        $friendRequest = Friend::first();
        $this->assertNotNull($friendRequest);
        $this->assertEquals($anotheUser->id, $friendRequest->friend_id);
        ...
        $response->assertJson([
            ...
            'links' => [
                'self' => url('/users/' . $anotheUser->id)
            ]
        ]);
    }

    /** @test */
    public function a_user_can_send_a_request_friend_only_once()
    {
        $this->withoutExceptionHandling();
        $this->actingAs($user = factory(User::class)->create(), 'api');
        $anotheUser = factory(User::class)->create();
    ...
    /** @test */
    public function only_valid_users_can_be_friend_request()
    {
    ...
    public function friend_request_can_be_accepted()
    {
        ...
        $response = $this->actingAs($anotheUser, 'api')
    ...
    public function only_valid_users_can_be_friend_requested()
    {
        ...
        $anotheUser = $this->actingAs(factory(User::class)->create(), 'api');
    ...
    public function a_friendship_is_retrieved_when_fetching_the_profile()
    {
        ...
        $this->get('api/users/' . $anotheUser->id)
            ->assertStatus(200)
            ->assertJson([
                'data' => [
                    'attributes' => [
